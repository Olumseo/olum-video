...
const FAN: PhoneClip[] = [
  {
    ...
    duration: "0:33",
    origin: "Recorded once, on a phone",
    width: 624,
    height: 1110,
  },
  {
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-10">
        ...
        <div>
          ...
          <Reveal delay={320}>
            <div className="mt-9 flex flex-wrap items-center gap-3">
              {/* Plain <a>, deliberately NOT a react-router <Link>. The client
                  app is a SEPARATE application at /video with its own bundle —
                  <Link> would search this app's route table, miss, and render
                  this app's 404. */}
              <Magnetic>
                <a
                  href="/video"
        ...
        <Reveal delay={140}>
          <div className="relative mx-auto w-full max-w-[560px] lg:max-w-none lg:pt-14">
            ...
            >
              Your AI clone. Posting every day.
            </Annotation>
          </div>
        </Reveal>
      </div>
